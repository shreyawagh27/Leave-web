...
class _CalendarPageState extends State<CalendarPage> {
  ...
  List<Map<String, dynamic>> nationalHolidays = [
    ...
    {"date": DateTime(2025, 8, 15), "name": "Parsi New Year (Shahenshahi)"},
    {"date": DateTime(2025, 8, 27), "name": "Ganesh Chaturthi"},
    {"date": DateTime(2025, 9, 5), "name": "Eid e Milad"},
    {"date": DateTime(2025, 10, 2), "name": "Gandhi Jayanti / Vijayadashami"},
    {"date": DateTime(2025, 10, 21), "name": "Diwali (Amavasya)"},
    {"date": DateTime(2025, 10, 22), "name": "Diwali (Bali Pratipada)"},
    {"date": DateTime(2025, 11, 5), "name": "Guru Nanak Jayanti"},
    {"date": DateTime(2025, 12, 25), "name": "Christmas Day"},
  ];
            ...
            child: TableCalendar(
              ...
              calendarBuilders: CalendarBuilders(
                defaultBuilder: (context, day, focusedDay) {
                  ...
                  // my leave condition if condition
